  ...
  return (
    <div className={styles.ownershipDashboardPage}>
      <div className={styles.pageHeader}>
        ...
        <div className={styles.headerDecoration2} />
        ...
        <div className={styles.headerActions}>
          <Button
            ...
            icon={<ReloadOutlined className={styles.refreshIcon} />}
            onClick={() => {
              fetchStats();
              fetchAssets();
            }}
          >
            <span className={styles.buttonText}>刷新</span>
          </Button>
        </div>
      </div>
          ...
          <Card className={`${styles.statCard} ${styles.statCardTotal}`}>
            ...
            <div className={styles.statCardContent}>
              <div className={styles.statIconWrapper}>
                ...
                <div className={styles.statIconPulse} />
              </div>
              <Statistic
                title={<span className={styles.statTitle}>资产总数</span>}
                value={stats?.total_count || 0}
                className={styles.statistic}
              />
              <div className={styles.statTrend}>
                <span className={styles.trendText}>全部资产</span>
              </div>
            </div>
          </Card>
        </Col>
        <Col xs={12} sm={6}>
          <Card className={`${styles.statCard} ${styles.statCardActive}`}>
            ...
            <div className={styles.statCardContent}>
              ...
              <Statistic
                title={<span className={styles.statTitle}>有效资产</span>}
              ...
              <div className={styles.statTrend}>
                <span className={styles.trendUp}>
                  +{(((stats?.active_count || 0) / (stats?.total_count || 1)) * 100).toFixed(1)}%
                </span>
                <span className={styles.trendText}>占比</span>
              </div>
            </div>
          </Card>
        </Col>
        <Col xs={12} sm={6}>
          <Card className={`${styles.statCard} ${styles.statCardLicensed}`}>
            <div className={styles.statCardGlow} />
            <div className={styles.statCardContent}>
              <div className={styles.statIconWrapper}>
              ...
              <Statistic
                title={<span className={styles.statTitle}>许可中</span>}
                value={stats?.licensed_count || 0}
                className={styles.statistic}
                valueStyle={{ color: '#1890ff' }}
              />
              <div className={styles.statTrend}>
                <span className={styles.trendText}>授权许可</span>
              </div>
            </div>
          </Card>
        </Col>
        <Col xs={12} sm={6}>
          <Card className={`${styles.statCard} ${styles.statCardStaked}`}>
            <div className={styles.statCardGlow} />
            <div className={styles.statCardContent}>
              <div className={styles.statIconWrapper}>
                <LockOutlined className={styles.statIcon} />
                <div className={styles.statIconPulse} />
              </div>
              <Statistic
                title={<span className={styles.statTitle}>质押中</span>}
                value={stats?.staked_count || 0}
                className={styles.statistic}
                valueStyle={{ color: '#faad14' }}
              />
              <div className={styles.statTrend}>
                <span className={styles.trendText}>资产锁定</span>
              </div>
            </div>
          </Card>
        </Col>
